...
``` typescript
import * as pkg from 'https://unpkg.com/getsetdeep@^5.2.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/getsetdeep@^5.2.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/getsetdeep@^5.2.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/getsetdeep@5.2.0'
</script>
```
