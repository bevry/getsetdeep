...
<span class="badge-thanksapp"><a href="https://givethanks.app/donate/npm/getsetdeep" title="Donate to this project using Thanks App"><img src="https://img.shields.io/badge/thanksapp-donate-yellow.svg" alt="Thanks App donate button" /></a></span>
<span class="badge-boostlab"><a href="https://boost-lab.app/bevry/getsetdeep" title="Donate to this project using Boost Lab"><img src="https://img.shields.io/badge/boostlab-donate-yellow.svg" alt="Boost Lab donate button" /></a></span>
...
<li>Require: <code>require('getsetdeep')</code></li>
</ul>
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/getsetdeep'
</script>
```
...
<ul><li><code>getsetdeep</code> aliases <code>getsetdeep/source/index.js</code></li>
<li><code>getsetdeep/source/index.js</code> is esnext source code with require for modules</li>
<li><code>getsetdeep/edition-browsers/index.js</code> is esnext compiled for browsers with require for modules</li></ul>
