...
``` typescript
import * as pkg from 'https://unpkg.com/getsetdeep@^4.12.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.pika.dev/getsetdeep/^4.12.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/getsetdeep@^4.12.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/getsetdeep@4.12.0'
</script>
```
