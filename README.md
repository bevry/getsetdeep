...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/getsetdeep@^4.19.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/getsetdeep@^4.19.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/getsetdeep@4.19.0'
</script>
```
